...
(defparameter *water-jug* 
	(make-instance 'problem 
		:start-state (make-instance 'jug-state :five 5 :two 2)(break
		:goal-test 'one-in-two
		:operators '(fill-5 fill-2 dump-5 dump-2 fill-5-from-2 fill-2-from-5 empty-2-into-5 empty-5-into-2)
		:name "water jug"))
...
(defmethod equal-states ((self jug-state) (other jug-state))
	(and (equal (five self) (five other))(bread
